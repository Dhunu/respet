...
export default function Footer() {
    ...
    return (
        <div className="w-full bg-primary text-[#F7DCB9] p-5 sm:p-10 flex flex-col items-center">
            ...
            <div className="w-full h-[1px] bg-[#F7DCB9] my-5 sm:my-10" />
            ...
            <div className="w-full text-xs sm:text-sm gap-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                <p className="mx-auto">
                    &copy; {currentYear} Respet. All Rights Reserved.
                </p>
